<nav 
    x-data="{ open: false }" 
    class="fixed top-0 left-0 w-full bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700 z-50"
>
            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('rides.create')" :active="request()->routeIs('rides.create')">
                        {{ __('navigation.add_ride') }}
                    </x-nav-link>

                    <x-nav-link :href="route('failed-jobs.index')" :active="request()->routeIs('failed-jobs.index')">
                        {{ __('navigation.failed_rides') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('failed-jobs.index')" :active="request()->routeIs('failed-jobs.index')">
                {{ __('navigation.failed_rides') }}
            </x-responsive-nav-link>
